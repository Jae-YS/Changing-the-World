  ...
  return (
    <div className="MySchedule">
      ...
      <div>
        <h2>Description</h2>
        <p>
          Creative Writing - Imagine you find a magic lamp with a genie inside
          who grants you three wishes. Write a story describing your three
          wishes and how they come true. Your story should be at least 5
          paragraphs.
        </p>
      </div>
      <div className="editor-spacing">
        ...
        />
        <button className="button-spacing" onClick={handleSubmit}>
          Submit
        </button>
      </div>
      {submitted && (
